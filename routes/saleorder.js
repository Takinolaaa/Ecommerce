...
router.post('/', function(req, res, next) {
    ...
    db.query(insertquery,[req.body.customer_id, req.body.saledate, req.body.customernotes,
...
router.post('/save', function(req, res, next) {
    let updatequery = "UPDATE saleorder SET   order_id = ?, customer_id = ?, saledate = ?, customernotes = ?, paymentstatus = ?, authorizationnum = ? WHERE order_id = " + req.body.order_id;
    db.query(updatequery,[    req.body.order_id, req.body.customer_id, req.body.saledate, req.body.customernotes, req.body.paymentstatus,
    req.body.authorizationnum ],(err, result) => {
    if (err) {
    console.log(err);
    res.render('error');
    } else {
