...
router.post('/', function(req, res, next) {
   ...
   db.query(insertquery,[req.body.suppliername, req.body.pointofcontact, req.body.weburl,
   req.body.suppliernotes],(err, result) => {
   if (err) {
   console.log(err);
   res.render('error');
   } else {
...
router.post('/save', function(req, res, next) {
   ...
   db.query(updatequery,[req.body.suppliername, req.body.pointofcontact, req.body.weburl,
   req.body.suppliernotes],(err, result) => {
   if (err) {
   console.log(err);
   res.render('error');
